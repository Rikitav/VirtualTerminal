...
/// <summary>
/// Approximate Unicode character width for terminal grid layout (East Asian Width + emoji).
/// Returns -1 for non-printable control/format codepoints, 0 for zero-width combining marks,
/// 1 for normal, 2 for wide/fullwidth (CJK, fullwidth punctuation, emoji). Tables are derived
/// from the public-domain Markus Kuhn <c>wcwidth</c> data, trimmed to the high-impact ranges.
/// </summary>
public static class Wcwidth
{
    /// <summary>Zero-width (combining) ranges, inclusive [start, end].</summary>
    private static readonly (int Start, int End)[] ZeroWidth =
    [
        ...
        (0x0B4D, 0x0B4D), (0x0B55, 0x0B56), (0x0B62, 0x0B62), (0x0B63, 0x0B63),
    ...
    /// <summary>Wide / fullwidth ranges, inclusive [start, end].</summary>
    private static readonly (int Start, int End)[] Wide =
    [
        (0x1100, 0x115F), (0x2329, 0x232A), (0x2E80, 0x303E), (0x3040, 0x3040),
        ...
        (0x1AFF0, 0x1AFFE), (0x1B000, 0x1B0FF), (0x1B100, 0x1B12F), (0x1B150, 0x1B167),
        (0x1B170, 0x1B2FF), (0x1F004, 0x1F004), (0x1F0CF, 0x1F0CF), (0x1F18E, 0x1F18E),
        (0x1F191, 0x1F19A), (0x1F200, 0x1F320), (0x1F330, 0x1F335), (0x1F337, 0x1F37C),
    ...
    /// <summary>
    /// Width of <paramref name="rune"/>: -1 non-printable, 0 zero-width, 1 normal, 2 wide.
    /// </summary>
    ...
    private static bool InRanges(int value, (int Start, int End)[] ranges)
    {
        int lo = 0;
        ...
        {
            int mid = lo + ((hi - lo) >> 1);
            ref readonly (int Start, int End) r = ref ranges[mid];
